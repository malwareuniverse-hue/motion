...
export const OwnerEyesShortScene: React.FC = () => {
  const frame = useCurrentFrame();

  // the contrast + the owner's claim share one stage, which cross-dissolves
  // to the rebuttal card exactly on the transcript's own pause
