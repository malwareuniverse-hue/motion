...
export const ProblemMayBeYouScene: React.FC = () => {
  const frame = useCurrentFrame();

  // act 1 -> act 2 crossfade, keyed on the transcript's own pause
  ...
  // within act 2, the flipped scenario fades as the causes/punchline card takes over
